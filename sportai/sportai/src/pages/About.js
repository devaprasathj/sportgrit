              ...
              <div className="space-y-8">
                ...
                <div className="p-6 rounded-[2rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/20">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="text-white font-black uppercase tracking-[0.2em] text-xs">Our Core Team</h4>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center bg-slate-900/40 p-3 rounded-xl border border-slate-800/50">
                      <div>
                        <p className="text-white font-bold text-sm">Devaprasath J</p>
                        <p className="text-blue-400 text-[10px] font-black uppercase tracking-wider">Team Lead</p>
                      </div>
                      <span className="text-slate-400 text-xs bg-slate-800 px-2 py-1 rounded-md">Developer</span>
                    </div>
                    <div className="flex justify-between items-center bg-slate-900/40 p-3 rounded-xl border border-slate-800/50">
                      <div>
                        <p className="text-white font-bold text-sm">Dharsankumar RK</p>
                        <p className="text-purple-400 text-[10px] font-black uppercase tracking-wider">Member</p>
                      </div>
                      <span className="text-slate-400 text-xs bg-slate-800 px-2 py-1 rounded-md">AI Engineer</span>
                    </div>
                    <div className="flex justify-between items-center bg-slate-900/40 p-3 rounded-xl border border-slate-800/50">
                      <div>
                        <p className="text-white font-bold text-sm">Immanuel Franklin</p>
                        <p className="text-emerald-400 text-[10px] font-black uppercase tracking-wider">Member</p>
                      </div>
                      <span className="text-slate-400 text-xs bg-slate-800 px-2 py-1 rounded-md">Tester</span>
                    </div>
                  </div>
                </div>
              </div>
